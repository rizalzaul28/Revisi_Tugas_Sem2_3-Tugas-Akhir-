...
public class menuLogBagian extends javax.swing.JPanel {
    ...
    public void loadTabel() throws ParseException {
        ...
        tb_LogBagian.getColumnModel().getColumn(1).setPreferredWidth(80); // Kolom "Kolom yang berubah"
        ...
        tb_LogBagian.getColumnModel().getColumn(4).setPreferredWidth(110); // Kolom "Waktu"
        tb_LogBagian.getColumnModel().getColumn(5).setPreferredWidth(230); // Kolom "Keterangan"
