...
public class menuLogSuratKeluar extends javax.swing.JPanel {
     ...
     */
    public menuLogSuratKeluar() throws ParseException {
        initComponents();
        loadTabel();
    }
    ...
    public void loadTabel() throws ParseException {
        ...
        tb_LogSuratKeluar.setModel(model);

        // Mengatur word wrap di setiap kolom tabel
        tb_LogSuratKeluar.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            @Override
        ...
        tb_LogSuratKeluar.setRowHeight(40);

        // Mengatur ukuran kolom
        tb_LogSuratKeluar.getColumnModel().getColumn(0).setPreferredWidth(90); // Kolom "User Login"
        tb_LogSuratKeluar.getColumnModel().getColumn(1).setPreferredWidth(80); // Kolom "Kolom yang berubah"
        tb_LogSuratKeluar.getColumnModel().getColumn(2).setPreferredWidth(130); // Kolom "Nilai Lama"
        tb_LogSuratKeluar.getColumnModel().getColumn(3).setPreferredWidth(130); // Kolom "Nilai Baru"
        tb_LogSuratKeluar.getColumnModel().getColumn(4).setPreferredWidth(110); // Kolom "Waktu"
        tb_LogSuratKeluar.getColumnModel().getColumn(5).setPreferredWidth(230); // Kolom "Keterangan"

        // Mengatur agar tabel tidak bisa diubah ukuran kolomnya atau di-geser
        tb_LogSuratKeluar.getTableHeader().setReorderingAllowed(false); // Tidak bisa geser header
        tb_LogSuratKeluar.getTableHeader().setResizingAllowed(false);   // Tidak bisa ubah ukuran kolom
    }
